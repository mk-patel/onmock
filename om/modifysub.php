...
<html>
    ...
    <body class="bg">
		...
		<div class="test-sel">
			...
			?>
			<div class="test-sub" >
				<h4><span class="tstid">(TestID - <?php echo $row['tid'];?>)</span> <br/><?php echo $row['test_name'];?> </h4>
				<p>Total Questions - <mark>  <?php echo $row['no_of_qust'];?> </mark></p>
				<a href="deletesub.php?delid=<?php echo $row['tid'];?>"><button class="btn btn-danger">Delete </button></a> | 
				<a href="editsub.php?edid=<?php echo $row['tid'];?>"><button class="btn btn-success">Edit </button></a>
			</div>
			<br/>
			<?php
				}
